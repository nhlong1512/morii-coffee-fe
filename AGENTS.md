...
- TypeScript 5.x + Next.js 16.1.6 (App Router) + React 19.2.3, Zustand 5.0.11, next-intl 4.8.3, Tailwind CSS v4, Lucide React, next/image (008-cart-order-checkout)
