        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="profileDob">{t("dateOfBirth")}</Label>
                {isEditing ? (
                  <Input
                    id="profileDob"
                    type="date"
                  ...
                  <p className="rounded-md border border-border bg-muted px-3 py-2 text-sm text-foreground">
                    {user.dob
                      ? new Intl.DateTimeFormat(locale === "vi" ? "vi-VN" : "en-US").format(new Date(user.dob))
                      : t("notSet")}
                  </p>
                )}
              </div>
              <div className="space-y-2">
                <Label htmlFor="profileGender">{t("gender")}</Label>
                {isEditing ? (
                  <Select value={editGender} onValueChange={setEditGender}>
                    ...
                    <SelectContent>
                      <SelectItem value={EGender.Male}>{t("male")}</SelectItem>
                      <SelectItem value={EGender.Female}>{t("female")}</SelectItem>
                      <SelectItem value={EGender.Other}>{t("other")}</SelectItem>
                    </SelectContent>
                  </Select>
                ) : (
                  <p className="rounded-md border border-border bg-muted px-3 py-2 text-sm text-foreground">
