  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-3 md:grid-cols-[1.8fr_1fr_auto_auto]">
          <Input
          ...
          <Button variant="outline" onClick={locatorState.requestNearMe}>
            <Navigation className="h-4 w-4" />
            {t("nearMe")}
          </Button>
          {locatorState.isNearMeActive ? (
            <Button variant="ghost" onClick={locatorState.clearNearMe}>
              {t("clearNearMe")}
            </Button>
          ) : (
            <div />
